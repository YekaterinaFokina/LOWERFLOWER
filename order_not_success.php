...
<head>
    ...
    <title>Ошибка платежа - Lover Flower</title>
    ...
    <style>
        ...
        .success-image {
            ...
            width: 850px;
            height: 1000px;
            background-image: url('img/image 150.png');
...
<div class="success-container">
    <h1 class="success-title">Ошибка <br><span>платежа</span></h1>
    
    <div class="order-number">Произошла ошибка....<br><br><br><br><br>Попробуйте оплатить еще раз!</div>
    
    <div class="checkout1">
        <a href="order.php" class="checkout-btn">Оплатить еще раз</a>
