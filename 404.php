...
<head>
    ...
    .cart-icon-container {
        position: relative;
        cursor: pointer;
        display: flex; /* Добавлено для лучшего выравнивания */
        align-items: center; /* Выравнивание по центру по вертикали */
    }
...
<div class="success-container">
    <div class="text">
        <div class="order-number">Ошибка 404<br><br><br>Упс...Такой страницы нет</div>
...
<!-- Main error image on the right -->
<div class="success-image"></div>
    
    <!-- New image elements -->
    <div class="error-image-left" style="position: absolute;/* left: 50px; */top: 150px;width: 1100px;height: 1000px;background-image: url('img/image 151.png');background-size: contain;background-repeat: no-repeat;z-index: -1;"></div>

    <div class="error-image-right" style="position: absolute;right: 0px;top: 200px;width: 251px;height: 700px;background-image: url('img/image 153.png');background-size: contain;background-repeat: no-repeat;z-index: -1;"></div>    
    <!-- Background elements behind image 151 -->
    <div class="bg-element-4-1" style="position: absolute;left: 150px;top: 200px;width: 320px;height: 320px;background-image: url('img/4.png');background-size: contain;background-repeat: no-repeat;z-index: -2;"></div>
    <div class="bg-element-4-2" style="position: absolute;left: 600px;top: 140px;width: 250px;height: 310px;background-image: url('img/4.png');background-size: contain;background-repeat: no-repeat;z-index: -2;"></div>
    <!-- Element in front of image 151 -->
    <div class="bg-element-0" style="position: absolute;left: 380px;top: 400px;width: 250px;height: 250px;background-image: url('img/0.png');background-size: contain;background-repeat: no-repeat;z-index: 0;"></div>
    
    <!-- Lover flower text -->
    <div class="lover-flower-text" style="position: absolute;right: 150px;top: 370px;width: 400px;height: 170px;background-image: url('img/lover flower404.png');background-size: contain;background-repeat: no-repeat;z-index: 0;"></div>

    <!-- Ellipse elements -->
    <div class="ellipse-43" style="position: absolute;left: -50px;bottom: 350px;width: 1000px;height: 300px;background-image: url('img/Ellipse 43(1).png');background-size: contain;background-repeat: no-repeat;z-index: -2;"></div>
    <div class="ellipse-44-1" style="position: absolute;left: 950px;bottom: 200px;width: 400px;height: 400px;background-image: url('img/Ellipse 44.png');background-size: contain;background-repeat: no-repeat;z-index: -3;"></div>
    <div class="ellipse-44-2" style="position: absolute;left: 1050px;top: 30px;width: 300px;height: 500px;background-image: url('img/Ellipse 44.png');background-size: contain;background-repeat: no-repeat;z-index: -3;"></div>
...
<?php if (!empty($success_message)): ?>
    <div class="success-message" style="position: fixed; top: 20px; right: 20px; background: green; color: white; padding: 10px; z-index: 10001;">
